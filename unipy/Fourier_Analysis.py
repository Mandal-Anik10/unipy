...
"""
1. Fourier Decomposition: Fourier(y_data, xi, yi, n, nc)

Discription: It'll return coff. of sines and coff. of cosines and fourier function
"""
...
def Fourier(y_data, xi, xf, n, nc):
    ...
    for i in range(n):
        ...
        yy.append(s)
    return cc,cs,yy         # IT WILL RETURN COEF. OF SINES, COEF. OF COSINS AND FOURIER FUNCTION:
